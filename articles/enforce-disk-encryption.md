...
See the [disk encryption API documentation](https://fleetdm.com/docs/rest-api/rest-api#update-disk-encryption-enforcement).
...
* Verified: the host turned disk encryption on and sent their key to Fleet. Fleet verified with osquery. See the [instructions for viewing the disk encryption key](#view-disk-encryption-key).
