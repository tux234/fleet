...
For Apple (macOS, iOS, and iPadOS) hosts, the you can find the list of available OS versions in the [Apple Software Lookup Service](https://gdmf.apple.com/v2/pmv). The update will only be enforced if you use a version in that list.
...
Fleet enforces OS updates for quality and feature updates. Read more about the types of Windows OS updates in the [Microsoft Windows update documentation](https://learn.microsoft.com/en-us/windows/deployment/update/get-started-updates-channels-tools#types-of-updates).
